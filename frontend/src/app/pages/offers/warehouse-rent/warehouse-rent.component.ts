...
@Component({
  selector: 'app-warehouse-rent',
  templateUrl: './warehouse-rent.component.html',
  styleUrls: ['./warehouse-rent.component.scss']
})
export class WarehouseRentComponent implements OnInit {
  offers: any;
  totalRecords: number;
  currentPage: number;
  ...
  setDefaultFilters(){
    this.defaultFilters[0].value = this.propertyTypes.find((x:any) => x.name === 'magazyn').id;
