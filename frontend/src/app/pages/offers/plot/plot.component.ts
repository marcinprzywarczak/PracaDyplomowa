...
export class PlotComponent implements OnInit {
  ...
  getPropertyId(){
    this.propertyTypeId = this.propertyTypes.find((x:any) => x.name === 'działka').id;
  }
  ...
  getParameters(){
    this.apiService.getParametersForPropertyType(this.propertyTypeId)
      .subscribe((value: any) => {
        this.plotTypeOptions = value.find((x:any) => x.name === 'typ działki').parameter_values;
        this.fenceOptions = value.find((x:any) => x.name === 'ogrodzenie').parameter_values;
        this.drivewayTypeOptions = value.filter((x: any) => (x.parameter_category !== null && x.parameter_category.name === 'dojazd'));
  ...
  onSubmit(){
    ...
    if(this.form.controls['fence'].value !== null && this.form.controls['fence'].value !== ''){
    ...
    if(this.form.controls['drivewayType'].value !== null){
      this.form.controls['drivewayType'].setValue(this.form.controls['drivewayType'].value);
    ...
    if(this.form.controls['plotType'].value !== null  && this.form.controls['plotType'].value.length > 0){
      this.form.controls['plotType'].setValue(this.form.controls['plotType'].value);
      this.parameterValueIn.push({
        column: 'typ działki',
        operator: 'in',
