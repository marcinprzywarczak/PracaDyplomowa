...
export class HouseComponent implements OnInit {
  ...
  getPropertyId(){
    this.propertyTypeId = this.propertyTypes.find((x:any) => x.name === 'dom').id;
  }
  setDefaultFilters(){
    this.defaultFilters[0].value = this.propertyTypes.find((x:any) => x.name === 'dom').id;
  ...
  onSubmit(){
    ...
    if(this.form.controls['areaHouseFrom'].value !== null && this.form.controls['areaHouseFrom'].value !== ''){
      this.form.controls['areaHouseFrom'].setValue(this.form.controls['areaHouseFrom'].value);
      this.filters.push({
    ...
    if(this.form.controls['areaHouseTo'].value !== null && this.form.controls['areaHouseTo'].value !== ''){
      this.form.controls['areaHouseTo'].setValue(this.form.controls['areaHouseTo'].value);
      this.filters.push({
        column: 'area_square_meters',
        operator: '<=',
    ...
    if(this.form.controls['areaPlotFrom'].value !== null && this.form.controls['areaPlotFrom'].value !== ''){
      this.form.controls['areaPlotFrom'].setValue(this.form.controls['areaPlotFrom'].value);
    ...
    if(this.form.controls['areaPlotTo'].value !== null && this.form.controls['areaPlotTo'].value !== ''){
      this.form.controls['areaPlotTo'].setValue(this.form.controls['areaPlotTo'].value);
      this.parameterFilters.push({
        column: 'powierzchnia działki',
        operator: '<=',
    ...
    if(this.form.controls['roofingType'].value !== null  && this.form.controls['roofingType'].value.length > 0){
      this.form.controls['roofingType'].setValue(this.form.controls['roofingType'].value);
      this.parameterValueIn.push({
    ...
    if(this.form.controls['utilities'].value !== null){
      this.form.controls['utilities'].setValue(this.form.controls['utilities'].value);
