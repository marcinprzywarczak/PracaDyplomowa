...
@Component({
  selector: 'app-office-rent',
  templateUrl: './office-rent.component.html',
  styleUrls: ['./office-rent.component.scss']
})
export class OfficeRentComponent implements OnInit {
  offers: any;
  totalRecords: number;
  currentPage: number;
  ...
  setDefaultFilters(){
    this.defaultFilters[0].value = this.propertyTypes.find((x:any) => x.name === 'biuro').id;
