...
selected: string[] = [];
  ...
  onSubmit(){
    ...
    if(this.form.controls['propertyType'].value !== null){
      this.form.controls['propertyType'].setValue(this.form.controls['propertyType'].value);
      filters.push({
    ...
    if(this.form.controls['offerType'].value !== null){
      this.form.controls['offerType'].setValue(this.form.controls['offerType'].value);
      filters.push({
    ...
    if(this.form.controls['areaFrom'].value !== null && this.form.controls['areaFrom'].value !== ''){
      this.form.controls['areaFrom'].setValue(this.form.controls['areaFrom'].value);
      filters.push({
