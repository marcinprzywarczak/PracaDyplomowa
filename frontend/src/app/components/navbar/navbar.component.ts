...
export class NavbarComponent implements OnInit {
  ...
  onDocumentClick(event: MouseEvent) {
    if (
      !(event.target == document.getElementById('dropdown-plot')) &&
      !(event.target == document.querySelector('#dropdown-plot-icon'))
    ) {
      const menu = document.querySelector('#dropdown-content-plot')!;
      if (!menu.classList.contains('hidden')) menu.classList.toggle('hidden');
    }

    if (
      !(event.target == document.getElementById('dropdown-plot-mobile')) &&
    ...
    if (
      !(event.target == document.getElementById('dropdown-house')) &&
    ...
    if (
      !(event.target == document.getElementById('dropdown-house-mobile')) &&
    ...
    if (
      !(event.target == document.getElementById('dropdown-flat')) &&
    ...
    if (
      !(event.target == document.getElementById('dropdown-room')) &&
    ...
    if (
      !(event.target == document.getElementById('dropdown-flat-mobile')) &&
    ...
    if (
      !(event.target == document.getElementById('dropdown-room-mobile')) &&
    ...
    if (
      !(event.target == document.querySelector('#dropdown-user-mobile')) &&
